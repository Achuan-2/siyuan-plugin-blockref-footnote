## v1.6.4 / 20260919
- 🎨 脚注自动编号性能优化
- 🎨 脚注弹窗打开后的光标会自动落在${content}上，避免用户在移动鼠标
- 🐛 脚注自动编号：有些情况下脚注编号没有成功编号
...
## v1.6.2 / 20260815
- 🎨 脚注弹窗支持删除脚注
- 🎨 支持设置脚注插入样式：选择插入注脚或者插入引用
- 🎨 块引弹窗适配手机端
- 🐛 如果脚注文档选择子文档，第一次添加脚注后会报错
## v1.6.1 / 20260705
- 🐛 思源v3.7.0 无法把脚注插入标题块内
- 🐛 修复脚注弹窗有些情况下不聚焦单个块显示全文的问题
- 📝 限制安装本插件的思源版本为思源v3.7.0
...
## v1.4.9 / 2025.07.20
- ♻️ refactor(脚注): 当前文档的脚注容器标题不强迫是标题
- ✨ feat(脚注): 添加全屏遮罩样式和交互恢复
- 🐛 fix(脚注): 修复不开启悬浮窗，会导致脚注不编号
